...
.elgg-layout-one-sidebar {
	...
	background: transparent url(<?php echo elgg_get_site_url(); ?>mod/theme_bevolkingszorg/graphics/sidebar_background.png) repeat-y right top;
}
...
/* customs */
#theme-bevolkingszorg-kennisbank .slider img {
	width: 535px;
	margin-top: 3px;
}

#theme-bevolkingszorg-kennisbank .body {
	width: 525px;
	background: #F4F4F4;
	padding: 5px;
}