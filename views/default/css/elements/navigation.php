...
.elgg-menu-site-default-container
{
    ...
    background-image: url(<?php echo $graphics;?>elgg-site-menu-default-container-bg.png);
...
.elgg-menu-page a {
	...
	color: <?php echo COLOR_BLUE; ?>;
	border: 1px <?php echo COLOR_BLUE; ?> solid;
	border-bottom: 2px <?php echo COLOR_BLUE; ?> solid;
}
